...
public interface IAppointmentService
{
    ...
    Task ConfirmAppointmentAsync(string userId, int appointmentId, bool isOnline, CancellationToken cancellationToken);
    Task CancelAppointmentAsync(string userId, int appointmentId, CancellationToken cancellationToken);
    Task CompleteAppointmentAsync(string userId, int appointmentId, string? comment, CancellationToken cancellationToken);
