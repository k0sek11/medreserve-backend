...
public interface IClinicService
{
    ...
    Task<IReadOnlyList<Dto.SpecializationDto>> GetSpecializationAsync(CancellationToken cancellationToken);

    Task<IReadOnlyList<Dto.SpecializationDto>?> GetSpecializationByCityAsync(int cityId,
