...
public class ClinicsController(IClinicService service) : ControllerBase
{
    ...
    public async Task<ActionResult<IReadOnlyList<Dto.SpecializationDto>>> GetSpecializations(CancellationToken cancellationToken)
    {
    ...
    public async Task<ActionResult<IReadOnlyList<Dto.SpecializationDto>>> GetSpecializationsByCity(int cityId, CancellationToken cancellationToken)
    {
