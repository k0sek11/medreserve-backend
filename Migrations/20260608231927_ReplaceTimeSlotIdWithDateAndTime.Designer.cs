...
namespace Medreserve.Migrations
{
    ...
    [Migration("20260608231927_ReplaceTimeSlotIdWithDateAndTime")]
    partial class ReplaceTimeSlotIdWithDateAndTime
    {
            ...
            modelBuilder.Entity("Medreserve.Features.Appointment.Appointment", b =>
                {
                    ...
                    b.HasIndex("DoctorId", "AppointmentDate", "StartTime")
                        .IsUnique()
                        .HasDatabaseName("ix_appointments_doctor_id_appointment_date_start_time");
