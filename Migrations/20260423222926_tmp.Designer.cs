...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medreserve.Features.User.User", b =>
                {
            ...
            modelBuilder.Entity("Medreserve.Features.Doctor.Doctor", b =>
                {
                    b.HasOne("Medreserve.Features.User.User", "User")
            ...
            modelBuilder.Entity("Medreserve.Features.Payment.OfflinePaymentApproval", b =>
                {
                    b.HasOne("Medreserve.Features.User.User", "ApprovedByUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Medreserve.Features.User.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
